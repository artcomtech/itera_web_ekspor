...
<section class="section__container register__container" id="register">
    ...
    <div class="register__content">
        ...
        ?>
        <p class="section__subheader">LOGIN</p>
        <h2 class="section__header">Please fill the form</h2>
        <form action="pages/act/login.php" method="post">
            ...
            <p>Don't have an account? <a href="?page=register" style="color:#519872">Register</a></p>
         </form>
